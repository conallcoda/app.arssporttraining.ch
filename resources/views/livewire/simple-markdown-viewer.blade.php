<div class="flex gap-8">
    ...
    @if (count($this->tableOfContents) > 0)
        <aside class="hidden w-64 shrink-0 lg:block">
            <nav class="sticky top-4 max-h-[calc(100vh-2rem)] overflow-y-auto rounded-lg border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-800/50">
