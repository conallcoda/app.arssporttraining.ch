    ...
    @if ($this->exerciseDetail)
        <div class="flex-1 overflow-y-auto p-6 space-y-4">
            ...
            @if ($this->exerciseDetail['category'])
                <div>
                    <div class="text-xs font-medium uppercase tracking-wider text-zinc-400 dark:text-zinc-500">{{ __('Category') }}</div>
                    <div class="mt-1">
            ...
            @if (!empty($this->exerciseDetail['equipment']))
                <div>
                    <div class="text-xs font-medium uppercase tracking-wider text-zinc-400 dark:text-zinc-500">{{ __('Equipment') }}</div>
            ...
            @if (!empty($this->exerciseDetail['modifiers']))
                <div>
                    <div class="text-xs font-medium uppercase tracking-wider text-zinc-400 dark:text-zinc-500">{{ __('Modifiers') }}</div>
                    <div class="mt-1 flex flex-wrap gap-1">
            ...
            @if (!empty($this->exerciseDetail['badges']))
                <div>
                    <div class="text-xs font-medium uppercase tracking-wider text-zinc-400 dark:text-zinc-500">{{ __('Settings') }}</div>
            ...
            @if ($this->exerciseDetail['videoUrl'])
                <div>
                    <div class="text-xs font-medium uppercase tracking-wider text-zinc-400 dark:text-zinc-500">{{ __('Video') }}</div>
            ...
            @if ($this->exerciseDetail['instructions'])
                <div>
                    <div class="text-xs font-medium uppercase tracking-wider text-zinc-400 dark:text-zinc-500">{{ __('Instructions') }}</div>
