...
class FacetDefinition
{
    ...
    public function facetGroup(?string $facetGroup): static
    {
    ...
    {
        return $this->facetGroup($slot);
    }

    public function variant(string $facetGroup): static
    {
        return $this->facetGroup($facetGroup);
    }
    ...
    public function applicableToTaxonomyTerm(string $taxonomyType, int|string|null $taxonomyTerm, int $priority = 0): static
    {
        return $this->applicableWhen(
            taxonomyType: $taxonomyType,
            taxonomyTerm: $taxonomyTerm,
            priority: $priority,
        );
    ...
    public function excludeFromTaxonomyTerm(string $taxonomyType, int|string|null $taxonomyTerm, int $priority = 0): static
    {
        return $this->applicableWhen(
            taxonomyType: $taxonomyType,
            taxonomyTerm: $taxonomyTerm,
    ...
    public function applicableToSegment(string $segmentSlug, int $priority = 0): static
    {
        return $this->applicableWhen(
            segmentSlug: $segmentSlug,
            priority: $priority,
    ...
    public function excludeFromSegment(string $segmentSlug, int $priority = 0): static
    {
        return $this->applicableWhen(
            segmentSlug: $segmentSlug,
            priority: $priority,
