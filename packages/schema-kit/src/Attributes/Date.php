...
use Attribute;
use Coda\SchemaKit\DateCastTransformer;
use Coda\SchemaKit\DateInput;
use Coda\SchemaKit\FieldDefinition;
use Spatie\LaravelData\Attributes\WithCastAndTransformer;

#[Attribute(Attribute::TARGET_PROPERTY | Attribute::TARGET_PARAMETER)]
final class Date extends WithCastAndTransformer implements AppliesToFieldDefinition, ProvidesValidationRules
{
    ...
    {
        $outputFormat = $this->outputFormat ?? 'Y-m-d';
