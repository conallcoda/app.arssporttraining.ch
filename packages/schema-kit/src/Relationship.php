 ...
 * @method static to(?string $targetEntity)
 * @method static relationshipType(?string $relationshipType)
 * @method static belongsTo()
 * @method static taxonomy()
 * @method static weightedTaxonomy()
 * @method static multiple(bool $multiple = true)
 */
class Relationship extends RelationshipDefinition {}
