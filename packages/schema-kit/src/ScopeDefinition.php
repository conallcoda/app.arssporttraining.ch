...
final class ScopeDefinition
{
    ...
    {
        if ($dataPath !== '' && ! in_array($dataPath, $this->dataPaths, true)) {
            $this->dataPaths[] = $dataPath;
        }
    ...
    /**
     * @param  array<int, string>  $dataPaths
     */
    public function dataPaths(array $dataPaths): static
    {
