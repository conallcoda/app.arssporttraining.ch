@php
    $clientModalListsPayload = $clientModalListsPayload ?? (method_exists($field, 'getClientModalListPayload')
        ...
        : [
            [
                ...
                'button' => [
                    'visible' => true,
                    'action' => ['type' => 'local', 'name' => 'toggleRecord'],
                    'defaultLabel' => $field->selectButtonLabel,
            ...
            [
                ...
                'sortKey' => $field->sortable ? 'rowSortKey' : null,
                'selectedState' => 'always',
                'emptyText' => $field->emptySelectionText,
                'button' => [
                    'visible' => true,
                    'action' => ['type' => 'local', 'name' => 'toggleRecord'],
