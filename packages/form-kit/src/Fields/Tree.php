...
class Tree extends Field
{
    ...
    public function getRenderableTreeOptions(array $context = []): array
    {
        ...
        return $children !== [] ? $children : $options;
    }

    /** @return array<int, string> */
    public function flatOptions(array|string $context = [], string $separator = ' / '): array
    {
        ...
        $result = [];
        $this->flattenBranch($this->getRenderableTreeOptions($context), [], $separator, $result);
