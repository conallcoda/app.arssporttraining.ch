...
class CmsPackageServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(SchemaFormFieldFactory::class);
        $this->app->singleton(CmsSchemaPresenter::class, function ($app): CmsSchemaPresenter {
            return CmsSchemaPresenter::make(
                $app->make(SchemaRegistry::class),
                $app->make(SchemaFormFieldFactory::class),
            );
        });
    ...
    public function boot(): void
    {
        ...
        if (! $this->app->isProduction()) {
            $this->appendAutoLoginMiddlewareToWebGroup();
        }
    ...
    protected function appendAutoLoginMiddlewareToWebGroup(): void
    {
        $kernel = $this->app->make(HttpKernel::class);

        if (method_exists($kernel, 'appendMiddlewareToGroup')) {
            $kernel->appendMiddlewareToGroup('web', AutoLoginInDevelopment::class);
