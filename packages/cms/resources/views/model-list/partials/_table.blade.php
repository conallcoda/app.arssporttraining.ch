...
@php
    ...
    $sortableRowsConfig = $manualSortingEnabled ? '{ forceFallback: true, fallbackOnBody: true }' : '{}';
@endphp
...
<flux:table class="table-fixed">
    ...
    <flux:table.rows :x-data="$sortableRowsData" :x-sort="$sortableRowsHandler" :x-sort:config="$sortableRowsConfig">
